            ...
            <AnimatePresence>
                {phase === 'title' && (
                    ...
                    >
                        ...
                        >
                            {/* Header: Centered Minimalist Title */}
                            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center justify-center z-20 pointer-events-none">
                                <h1 className="text-4xl md:text-6xl font-bold tracking-[0.2em] text-white uppercase font-sans whitespace-nowrap" style={{ fontFamily: 'var(--font-rajdhani)' }}>
                                    DIMENSION : GATE
                                </h1>
                            ...
                            {/* Top Bar Info */}
                            <div className="flex justify-between items-start border-t border-primary/20 pt-4 opacity-70">
                            ...
                            {/* Center: Minimal Abstract Geometry */}
                            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                                <div className="relative w-[300px] h-[300px] md:w-[500px] md:h-[500px] flex items-center justify-center opacity-20">
